...
let categorySelect = document.querySelector('#category_select');
    ;(async() => {
        ...
        categorySelect.innerHTML += `<option value="">Выбрать категорию</option>`
        ...
        for(let product of products.products){
            ...
            if(product.category == selectedCategory){
                ...
                <div class="productblock">
                    ...
                    <button id="btn" onClick="sendId(${product.id})">Добавить в корзину</button><br>
                </div>`
